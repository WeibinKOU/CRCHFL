...
def build_parser():
    ...
    parser.add_argument("--pretrain_batch_cnt", type=str, default='', help="how many batches of data that each vehicle should upload to Cloud Server to pretrain ")
...
def main():
    ...
    pretrain_batch_cnt = []
    print(not args.pretrain_batch_cnt)
    if args.pretrain_batch_cnt:
